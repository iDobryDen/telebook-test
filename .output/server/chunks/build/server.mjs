import { version, unref, inject, useSSRContext, createApp, effectScope, reactive, mergeProps, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, hasInjectionContext, getCurrentInstance, toRef, ref, watchEffect, watch, defineAsyncComponent, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
...
const router_SmUaJhDlcj = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-6dafedb2"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C6paD54h.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-Dk8wMN1y.mjs').then((r) => r.default || r));
...
const server = /*#__PURE__*/Object.freeze({
  ...
  i: injectHead$1,
  n: navigateTo,
  r: resolveUnrefHeadInput$1,
  u: useRouter
});

export { _export_sfc as _, parseQuery as a, useRuntimeConfig as b, withoutTrailingSlash as c, hasProtocol as h, injectHead$1 as i, joinURL as j, navigateTo as n, parseURL as p, resolveUnrefHeadInput$1 as r, server as s, useRouter as u, withTrailingSlash as w };
